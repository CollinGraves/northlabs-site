(function() {
    ...
    css.textContent = [
        ...
        '.cm-submit { display:block; width:100%; padding:0.7rem; background:#0b73b9; color:#fff; font-size:0.9rem; font-weight:600; font-family:inherit; border-top:0.5px solid rgba(0,0,0,0.06); border-left:0.3px solid rgba(0,0,0,0.07); border-right:0.3px solid rgba(0,0,0,0.07); border-bottom:0.3px solid rgba(0,0,0,0.09); border-radius:6px; cursor:pointer; margin-top:0.5rem; transition:background 0.2s, transform 0.1s; box-shadow:0 2px 8px rgba(11,115,185,0.25); }',
        ...
        '.cm-thanks a { display:inline-block; padding:0.6rem 1.5rem; background:#0b73b9; color:#fff; font-size:0.875rem; font-weight:600; border-top:0.5px solid rgba(0,0,0,0.06); border-left:0.3px solid rgba(0,0,0,0.07); border-right:0.3px solid rgba(0,0,0,0.07); border-bottom:0.3px solid rgba(0,0,0,0.09); border-radius:6px; text-decoration:none; }',
